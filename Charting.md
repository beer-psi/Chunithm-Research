...
* A cell is the corresponding key for the note on the playfield. The playfield has 16 columns, numbers from 0-15 from left to right. You can enter numbers out of this range to place notes out of the playfield, as used in Melodiniq ULTIMA.
...
* Crush Tick: Interval between air crushes in ticks (e.g. if crush tick is 20 and the duration is 40 ticks, then there's 3 air crushes at tick 0, tick 20 and tick 40.)
